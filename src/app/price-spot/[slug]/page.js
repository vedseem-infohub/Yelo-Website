...
const slugToShopSlug = {
  'sweatshirt-under-799': 'price-spot-sweatshirts',
  'tshirt-under-299': 'price-spot-tshirts',
  'tracksuit-under-899': 'price-spot-tracksuits',
  'sweater-under-599': 'price-spot-sweaters',
  'kurta-set-under-599': 'price-spot-kurta-sets',
  'face-wash-under-199': 'price-spot-face-wash',
}

export default function PriceSpotShopPage() {
  ...
  return (
    <PageWrapper showLoader={false}>
      <div className="min-h-screen bg-gray-50 pb-24 pt-16 relative">
        {/* Main Content Area */}
