...
const LuxuryShopFilterPanel = ({ isOpen, onClose, filters, onApply, resultCount = 0 }) => {
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="mb-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-base md:text-sm focus:outline-none focus:ring-2 focus:ring-gray-900"
                      style={{ fontSize: '16px' }}
                    />
                  </div>
                </div>
                  ...
                  <div className="flex gap-3 items-center">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        placeholder="1000"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-base md:text-sm focus:outline-none focus:ring-2 focus:ring-gray-900"
                        style={{ fontSize: '16px' }}
                      />
                    </div>
                    <div className="flex-1">
              ...
              <FilterSection
                title="Availability"
                count={getSelectedCount('availability')}
                defaultOpen={false}
              >
                <div className="space-y-1">
...
export default LuxuryShopFilterPanel
